    ...
    <div>
      ...
      <main className="px-6 py-16 text-center max-w-3xl mx-auto">
        <img 
              ...
              />
        <h1 className="text-3xl font-bold mb-4">Welcome to <strong>ReTaskMan</strong></h1>
        <h2 className="text-2xl font-bold mb-4">The Ultimate Restaurant Task Manager</h2>
